...
//
//	mockgen -source client.go -destination mock/client.go -package mock -imports geth=github.com/ethereum/go-ethereum,gethcommon=github.com/ethereum/go-ethereum/common,gethtypes=github.com/ethereum/go-ethereum/core/types Client
//
...
func (m *MockClient) GetProof(ctx context.Context, account common.Address, keys []string, blockNumber *big.Int) (*gethclient.AccountResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProof", ctx, account, keys, blockNumber)
...
func (mr *MockClientMockRecorder) GetProof(ctx, account, keys, blockNumber any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProof", reflect.TypeOf((*MockClient)(nil).GetProof), ctx, account, keys, blockNumber)
}
...
func (mr *MockClientMockRecorder) NetworkID(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) PendingCallContract(ctx, call any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
